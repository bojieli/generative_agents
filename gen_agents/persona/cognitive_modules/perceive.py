...
from gen_agents.persona.prompt_template import run_gpt_prompt
from gen_agents.persona.prompt_template import gpt_structure
...
def generate_poig_score(persona, event_type, description):
    ...
    if event_type == "event":
        return run_gpt_prompt.run_gpt_prompt_event_poignancy(persona, description)[0]
    ...
    for p_event in perceived_events:
        ...
        if p_event not in latest_events:
            ...
            if desc_embedding_in in persona.a_mem.embeddings:
                ...
                event_embedding = gpt_structure.get_embedding(desc_embedding_in)
            ...
            if p_event[0] == f"{persona.name}" and p_event[1] == "chat with":
                ...
                if persona.scratch.act_description in persona.a_mem.embeddings:
                    ...
                    chat_embedding = gpt_structure.get_embedding(
                        persona.scratch.act_description
                    )
