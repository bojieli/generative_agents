...
from gen_agents.utils import collision_block_id
...
def execute(persona, maze, personas, plan):
    ...
    if not persona.scratch.act_path_set:
        ...
        if "<persona>" in plan:
            ...
            potential_path = path_finder.path_finder(
                maze.collision_maze,
            ...
            if len(potential_path) <= 2:
                ...
                potential_1 = path_finder.path_finder(
                    maze.collision_maze,
                    persona.scratch.curr_tile,
                    potential_path[int(len(potential_path) / 2)],
                    collision_block_id,
                )
                potential_2 = path_finder.path_finder(
                    maze.collision_maze,
                    persona.scratch.curr_tile,
        ...
        for i in target_tiles:
            ...
            curr_path = path_finder.path_finder(
