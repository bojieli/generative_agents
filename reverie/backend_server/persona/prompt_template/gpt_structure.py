...
def safe_generate_response(prompt,
  ...
  ##### NOTE: All the calls to the more expensive text-davinci-002/003 models are going through `def safe_generate_response`, so this will replace all those calls with calls to the much cheaper gpt-3.5-turbo.
